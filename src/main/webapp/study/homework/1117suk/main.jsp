...
<div class="container">
  <h2>회원 전용방</h2>
  <p><font color="blue">${KenenMid}</font>님 로그인 중이십니다.</p>
	<hr/>
	...
	<div class="row">
	  ...
	  <div class="col"><a href="${pageContext.request.contextPath}/study/homework/1117suk/login.jsp" class="btn btn-success form-control">로그아웃</a></div>
	</div>
	<hr/>
</div>
<p><br/></p>
