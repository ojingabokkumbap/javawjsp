...
<head>
		...
		<script>
			...
			else if(msg=="adminLoginOK") msg= "관리자 인증 성공했습니다.";
			else if(msg=="adminLoginNO") msg= "관리자 인증 실패했습니다.";
			...
			else if(msg=="loginOK") msg= val + "님 로그인 성공했습니다.";
			else if(msg=="loginNO") msg= "로그인 실패했습니다.";
			else if(msg=="memLogoutOK") msg= val + "님 로그아웃 성공했습니다.";
