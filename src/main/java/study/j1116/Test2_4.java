...
//	request.setAttribute(옆의 객체를 담아갈 변수 , 값을 저장한 객체변수);
		request.setAttribute("vo", vo); //저장소에 담기
//	request.getRequestDispatcher(forwarding할 주소)
		/*
		 * RequestDispatcher dispatcher =
		 * request.getRequestDispatcher("/study/1116/test2Ok4_2.jsp"); //값을 넘기기 위해 변수에
		 * 담기 dispatcher.forward(request, response); //저장소에 저장 완료
		 */
